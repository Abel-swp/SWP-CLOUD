<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<%@ include file="A2_top.jsp" %> <!-- 1. include 지시어(Original) -->
		<td colspan="8" align="center" style="height:200px;">
			<form method="post" action="C4_findpwProc.jsp">
			<table border="0" align="center" width="700" class="table table-striped">
				<caption style="text-align:center;"><font color="brown"><b>:: 비밀번호 찾기 ::</b></font></caption>
				<tr>
					<td bgcolor="#EFFA99" align="center">아이디</td>
					<td style="text-align:left;"><input type="text" name="id" size="18"></td>
				</tr>
				<tr>
				...
				<tr class="warning">
					<td colspan="2" bgcolor="#FFCC00" align="center" style="width:675px;">
						<input type="submit" value="비번 찾기" class="btn btn-warning">
					</td>
				</tr>
			</table>
			</form>
