                        ...
                        <div class="section-title product__discount__title">
								...
								<table class="table" style="width: 850px;">
									<tr style="background: #7fad39;">
										<th style="width: 300px;">서비스이름/제목</th>
										<th>구매자 닉네임</th>
										<th>재능구매일</th>
										<th>나눔기간</th>
										<th>개수/단위금액</th>
									...
									<c:forEach var="sell" items="${sellList }">
										<tr>
											<td><b>${sell.name }</b> / ${sell.catname }</td>
											<td>${sell.nickname }</td>
											<td><fmt:parseDate var="odate"
													value="${sell.buy_date }" pattern="yyyy-MM-dd HH:mm:ss" />
												<fmt:formatDate value="${odate }" pattern="yyyy-MM-dd" /></td>
											<td>${sell.amount2 }</td>
											<td>${sell.amount }/ ${sell.sellprice }</td>
											<td>${sell.sum }</td>
										</tr>
									</c:forEach>
								</table>
