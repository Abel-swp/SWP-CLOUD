                ...
                <div class="col-lg-3 col-md-5">
                    <div class="sidebar">
                        ...
                        <br><br>
                            <h4>마이 크몽</h4>
                            <ul>
                            	<li><b><a href="#">나의 구매내역</a></b></li>
                                <li><a href="abilityRequest.mb">재능 요청내역</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
	            <div class="section-title product__discount__title">
	              ...
	              <br><br><br>
	         	  <table class="table" style="width: 850px;">
		             <tr style="background: #7fad39;">
		             	<th style="width: 400px;">서비스이름/제목</th>
		             	<th>재능구매일</th>
		             	<th>나눔기간</th>
		             	<th>개수/단위금액</th>
		             	<th>총금액</th>
		             ...
		             <c:if test="${fn:length(orderList)==0 }">
		              ...
		              <c:forEach var="order" items="${orderList }">
			              <tr>
			             	 <td><b>${order.name }</b> / ${order.catname }</td>
			              	 <td> 
			              	 	<fmt:parseDate var="odate" value="${order.buy_date }" pattern="yyyy-MM-dd HH:mm:ss"/>
			              	 	 <fmt:formatDate value="${odate }" pattern="yyyy-MM-dd"/>
			              	 </td>
			              	 <td>${order.amount2 }</td>
			              	 <td>${order.amount } / ${order.sellprice }</td>
			              	 <td>${order.sum }</td>
			               </tr>
		               </c:forEach>
	              </table>
