            ...
            <div class="row">
                    ...
                    <div class="sidebar">
							<div class="sidebar__item">
								<input type="button" class="site-btn" value="사용자 전환"
									onClick="change('<%=conpath%>')" /> <br><br>
								<h4>마이 크몽</h4>
								<ul>
									<li><a href="sellinfo.mb">판매 관리</a></li>
									...
									<li><a href="donateinfo.mb">수익 관리</a></li>
								</ul>
							</div>
                    	</div>
                	</div>
                <div class="col-lg-9 col-md-7">
                   ...
                   <c:forEach var="lists" items="${lists }">
                   		<%-- <table border="1" align ="center" style="width: 58%; height:50px">
                   			<tr>
                   				<td> <img src=" <%=request.getContextPath()+"/resources/"%>${lists.simgname }" width="100px" height="100px"></td>
                   				<td width="400px">${lists.ref1 }-${lists.ref2 }&nbsp;&nbsp;${lists.pname }<hr>asd</td>
                   			</tr>
                   		</table> --%>
                   		<div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="blog__item">
                                ...
                                <div class="blog__item__text">
                                    <ul>
                                        <li><i class="fa fa-calendar-o"></i>${lists.inputdate }</li>
                                        <li><i class="fa fa-comment-o"></i> 5</li>
                                    </ul>
                                    <h5><a href="#">${lists.pname }</a></h5>
                                    <p>${lists.servicecontent } </p>
                                    <a href="detail.fm?num=${lists.num }" class="blog__btn">상세보기 <span class="arrow_right"></span></a>
                                    <a href="update.fm?num=${lists.num }" class="blog__btn">수정하기 <span class="arrow_right"></span></a>
                                    <a href="delete.fm?num=${lists.num }" class="blog__btn" onClick="deleteData()">삭제하기 <span class="arrow_right"></span></a>
                                </div>
                            </div>
                        </div>
                   </c:forEach>
