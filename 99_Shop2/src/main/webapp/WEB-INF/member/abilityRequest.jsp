                ...
                <div class="col-lg-3 col-md-5">
                    <div class="sidebar">
                        ...
                        <br><br>
                            <h4>마이 크몽</h4>
                            <ul>
                            	<li><a href="myPage.mb">나의 구매내역</a></li>
                                <li><b><a href="abilityRequest.mb">재능 요청내역</a></b></li>
                            </ul>
                        </div>
                    </div>
                </div>
	            <div class="section-title product__discount__title">
				  ...
				  <table class="table" style="width: 850px;"> 
					<tr style="margin: auto;text-align:center" bgcolor="#7fad39">
		             ...
		             <c:if test="${fn:length(brdList)==0 }">
						<tr><td align="center" colspan="5"><br><br><b>등록된 정보가 없습니다.</b></td></tr>
		              </c:if>
		              ...
		              <c:forEach var="board" items="${brdList }">
			             <tr>
							...
							<td align="center" style="text-align: left;">
								<a href="detailForm.brd?no=${board.no }&pageNumber=1" 
            ...
            <div class="row">
                <div class="col-lg-3 col-md-5">
                    <div class="sidebar">
                        ...
                        <input type="button"  class="site-btn" value="사용자 전환" onClick="change('<%=conpath%>')"/>
                        <br>
                            <h4><a href="myPage.mb">마이 크몽</a></h4>
                            <ul>
                                <li><a href="#">보낸 견적</a></li>
                            	<li><a href="sale.mb">판매 관리</a></li>
